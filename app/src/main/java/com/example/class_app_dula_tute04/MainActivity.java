package com.example.class_app_dula_tute04;
...
import com.example.class_app_dula_tute04.Database.DBHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        sign_in.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //boolean value =  userDb.readInfo(username.getText().toString(), password.getText().toString());
